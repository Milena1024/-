...
import { UseColorContext } from "./Contract/Context";
    ...
    return (
        <>
            ...
            <div style={{ Left: "float", marginLeft: "100px", marginRight: "100px" }}>
                ...
                <h4>Регистрация:</h4>
                Для возможности регистрации пользователя, необходимо перейти в раздел "Регистрация", предварительно кликнув по кнопке "Регистрация" на главной стрнице "Вход" ("Авторизация").
